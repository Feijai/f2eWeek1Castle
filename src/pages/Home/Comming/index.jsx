...
export default function Comming() {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.set(".spark", { opacity: 0, visibility: "hidden" });
  ...
  return (
    <CommingCss className="position-relative bg-black" ref={commingRef}>
      ...
      <h2 className="titleComming position-absolute text-center">
        年度最強合作
        <br />
        三大主題來襲
      </h2>
      ...
      <p className="text commingWeek1 position-absolute text-black">
        The F2E 活動網站設計
      </p>
      <p className="text commingWeek2 position-absolute text-black">
        今晚，我想來點點簽
      </p>
      <p className="text commingWeek3 position-absolute text-black">
        Scrum 新手村
      </p>
    </CommingCss>
  );
